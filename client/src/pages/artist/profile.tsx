          ...
          <div className="container mx-auto px-4 py-12">
            <div className="flex flex-col md:flex-row gap-8 mb-12">
              <div className="flex-shrink-0">
                {user.profileImage ? (
                  <img 
                    ...
                    className="w-40 h-40 rounded-full object-cover border-4 border-white shadow-lg blur-sm"
                  />
                ) : (
                  <div className="w-40 h-40 rounded-full bg-gray-200 flex items-center justify-center text-gray-500 text-4xl font-bold blur-sm">
                    {user.name.charAt(0)}
                  </div>
                )}
              </div>
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-700 max-w-3xl mb-6 line-clamp-2">{user.bio || "No bio provided"}</p>
                <div className="mt-6 p-4 bg-black/5 rounded-lg backdrop-blur-sm">
                  <p className="text-center font-medium">Sign in to view full artist profile and contact information</p>
                </div>
              </div>
            </div>
          </div>
